...
int main()
{
  ...
  // Some tests are just for overflow so the intermediate value was
  // not tested they are marked with `Overflow Check`
    {{{0, 0, 0},       {0, 0 , 0 }},// Overflow Check
     {{0, 0, 235},     {0, 0 , 0 }},// Overflow Check
     {{0, 235, 0},     {0, 0 , 0 }},// Overflow Check
     {{0, 235, 235},   {0, 0 , 0 }},// Overflow Check
     {{235, 0, 0},     {0, 0 , 0 }},// Overflow Check
     {{235, 0, 235},   {0, 0 , 0 }},// Overflow Check
     {{235, 235, 0},   {0, 0 , 0 }},// Overflow Check
     {{235, 235, 235}, {0, 0 , 0 }},// Overflow Check
     {{235, 235, 235}, {0, 0 , 0 }},// Overflow Check
